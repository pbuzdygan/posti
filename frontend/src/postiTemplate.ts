export const POSTI_TEMPLATE = String.raw`#!/usr/bin/env python3
...
export const START_MARKER = "# === POSTI PROFILE DATA START ===";
export const END_MARKER = "# === POSTI PROFILE DATA END ===";
...
export type SerializedProfiles = Record<string, SerializedProfile>;
...
export function extractProfilesFromScript(
  text: string
): { payload: SerializedProfiles; order: string[]; version: string } | null {
